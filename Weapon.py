...
class 	Automat(Weapon):
	...
	def shoot(self, obj):
		if (self.ammunition <= 0):
			print(RED + "END Ammunition!(" + FONE)
		else:
			if (random.random() < self.accuracy):
				obj.takeDamage(self)
			else:
				print(RED + "I didn't get it" + FONE)
			self.ammunition -= 1	
			self.__recharge()
	...
	# Private Methods
	def __recharge(self):
		print(PURPULE + "Recharge Automat")
